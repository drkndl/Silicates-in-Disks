...
dist_pc = 243 * u.pc                           			# Star distance in parsec
H = 1.0 * u.cm 								    		# Scale height (cm)

disk = 'HD179218' 										# The name of the disk
