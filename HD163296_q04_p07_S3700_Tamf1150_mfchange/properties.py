...
Sigma0 = 3700 * u.g / u.cm**2          					# Surface density with MMSN (g/cm^2)
...
disk = 'HD163296_q04_p07_S3700_Tamf1150_mfchange' 										# The name of the disk
...
amor_temp = 1150.0 * u.K 								# Temperature below which the grains are assumed to be amorphous
