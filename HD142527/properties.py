...
L_star = 10**1.46 * const.L_sun.cgs         			# Stellar luminosity
T_star = 6251.73 * u.K                         		# Effective temperature of the star (K)
Sigma0 = 1700 * u.g / u.cm**2          					# Surface density with MMSN (g/cm^2)
M_star = 2.5 * 1.99E33 * u.g         					# Solar mass (g)
...
dist_pc = 198 * u.pc                           			# Star distance in parsec
H = 1.0 * u.cm 								    		# Scale height (cm)

disk = 'HD142527' 										# The name of the disk
