...
Sigma0 = 4900 * u.g / u.cm**2          					# Surface density with MMSN (g/cm^2)
...
rgap = 0.8 * u.AU 										# The location of the gap in the disk (from the star) (AU)
...
rring = 1.9 * u.AU 										# The location of the gap in the disk (from the star) (AU)
wring = 1.4 * u.AU 										# Total width of the gap (AU)
sring = 10**2  											# The amount by which the surface density is to be dampened in the gap

disk = 'HD144432_q0373_p07_S4900_Tamf1350_mfchange4_gapring' 										# The name of the disk
...
amor_temp = 1350.0 * u.K 								# Temperature below which the grains are assumed to be amorphous
