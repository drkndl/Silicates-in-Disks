...
L_star = 10**1.54 * const.L_sun.cgs         			# Stellar luminosity
T_star = 8413.95 * u.K                         		# Effective temperature of the star (K)
Sigma0 = 1700 * u.g / u.cm**2          					# Surface density with MMSN (g/cm^2)
M_star = 2.3 * 1.99E33 * u.g         					# Solar mass (g)
...
dist_pc = 116 * u.pc                           			# Star distance in parsec
H = 1.0 * u.cm 								    		# Scale height (cm)

disk = 'HD104237' 										# The name of the disk
