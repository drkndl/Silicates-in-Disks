...
Sigma0 = 769.5397969301364 * u.g / u.cm**2          					# Surface density with MMSN (g/cm^2)
M_star = 1.8 * 1.99E33 * u.g         					# Solar mass (g)
q = -0.3 												# Disk temperature gradient exponent
...
disk = 'Temp' 										# The name of the disk
...
amor_temp = 1410.0 * u.K 								# Temperature below which the grains are assumed to be amorphous
