...
Sigma0 = 3000 * u.g / u.cm**2          					# Surface density with MMSN (g/cm^2)
...
sgap = 10**-10  											# The amount by which the surface density is to be dampened in the gap

disk = 'HD163296_q04_p075_S3000_Tamf1400_gap' 										# The name of the disk
...
amor_temp = 1400.0 * u.K 								# Temperature below which the grains are assumed to be amorphous
