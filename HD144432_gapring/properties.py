...
sring = 35  											# The amount by which the surface density is to be dampened in the gap

disk = 'HD144432_gapring' 										# The name of the disk
...
amor_temp = 700.0 * u.K 								# Temperature below which the grains are assumed to be amorphous
