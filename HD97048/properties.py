...
L_star = 10**1.64 * const.L_sun.cgs         			# Stellar luminosity
T_star = 10000 * u.K                         		# Effective temperature of the star (K)
...
dist_pc = 175 * u.pc                           			# Star distance in parsec
H = 1.0 * u.cm 								    		# Scale height (cm)

disk = 'HD97048' 										# The name of the disk
