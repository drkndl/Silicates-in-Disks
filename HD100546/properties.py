...
L_star = 10**1.51 * const.L_sun.cgs         			# Stellar luminosity
T_star = 10495.42 * u.K                         		# Effective temperature of the star (K)
Sigma0 = 1700 * u.g / u.cm**2          					# Surface density with MMSN (g/cm^2)
M_star = 2.4 * 1.99E33 * u.g         					# Solar mass (g)
...
dist_pc = 103 * u.pc                           			# Star distance in parsec
H = 1.0 * u.cm 								    		# Scale height (cm)

disk = 'HD100546' 										# The name of the disk
