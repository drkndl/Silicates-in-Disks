...
rring = 0.7 * u.AU 										# The location of the gap in the disk (from the star) (AU)
wring = 0.2 * u.AU 										# Total width of the gap (AU)
sring = 10**1  											# The amount by which the surface density is to be dampened in the gap

disk = 'HD144432_q0373_p07_S4500_Tamf1350_mfchange4_gapring' 										# The name of the disk
...
amor_temp = 1300.0 * u.K 								# Temperature below which the grains are assumed to be amorphous
